...
def main():
    ...
    for (train_state, model, lr,loss, prior_version, additive_smooth) in itertools.product(
        ...
        experiment_name = f"{train_state}_{model}_{lr}_{loss}_{prior_version}_additive_smooth_{additive_smooth}"
        ...
        command = (
            ...
            + f" experiment.datamodule.train_state={train_state}"
